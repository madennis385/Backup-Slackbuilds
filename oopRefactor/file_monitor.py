...
class FileMonitor:
    def __init__(self, monitor_dir, file_extensions, dest_subdir_name, check_interval, stable_threshold):
    ...
    def scan_files(self):
        try:
            return {
                ...
                if f.is_file() and f.suffix == self.file_extensions
            }
        except OSError as e:
    ...
    def run(self):
        ...
        logging.info(f"Monitoring directory: {self.monitor_dir} for *{self.file_extensions} files.")
        try:
            while True:
